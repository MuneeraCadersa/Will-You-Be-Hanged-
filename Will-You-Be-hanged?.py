...
def main():
    welcome = ['Welcome to Will-You-Be-Hanged? A word will be randomly chosen and',
               'you must try to guess the word correctly one letter at a time',
    ...
    while play_again:
        ...
        words = ["ambition", "mathematics", "blackboard", "coronavirus", "online",
                 "computer", "python", "program", "programming", "finals",
                 "software", "drexel", "friends", "structures", "biology",
                 "algebra", "physics", "informatics", "zybooks", "chemistry"
                 ]
